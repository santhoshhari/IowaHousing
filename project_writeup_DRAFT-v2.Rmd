...
# Plot
plot(student_resid$ix, student_resid$resid, col = ifelse(workingDF$Id %in% influential_points, "red", "black"), pch = ifelse(workingDF$Id %in% influential_points, 19, 1), main = "Plot of Studentized Residuals", xlab = 'Observation' )
abline(h = t, col = 'red')
abline(h = 0, col = 'red')
abline(h = -t, col = 'red')
...
# Plot
plot(standard_resid$ix, standard_resid$resid, col = ifelse(workingDF$Id  %in% influential_points, "red", "black"), pch = ifelse(workingDF$Id  %in% influential_points, 19, 1), main = "Plot of Standardized Residuals", xlab = 'Observation' )
abline(h = t, col = 'red')
abline(h = -t, col = 'red')
...
At first glance, the multiple R-squared value of 0.9551 indicates that 95.51% of the variability in SalePrice around its mean is explained by the mode, i.e. by the predictor variables that have been included. This suggests a high-performing explanatory model. 
